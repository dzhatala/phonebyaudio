...
public final class SpectralSubstraction {
	...
	public static void perform(String ssrc, String stgt) {
		try {
			...
			//padding, HTK complain .. if not padded
			int padLength=(int)nWavFile.getFramesRemaining();
			double []pads=new double[padLength];
			nWavFile.writeFrames(pads,pads.length);
